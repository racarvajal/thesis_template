...
\usepackage[natbib=true,sorting=nyt,backend=biber,maxcitenames=2,maxbibnames=5,minbibnames=3,mincitenames=1,style=authoryear,sortcites=false,uniquename=false,uniquelist=false]{biblatex}
